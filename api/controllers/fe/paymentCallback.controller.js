...
const ticketService =
  require("../../services/fe/ticket.service");

const payoutService =
  require("../../services/dash/payout.service");
      ...
      try {
        ...
        if (
          ...
          if (!fin) {
            ...
            await CreatorFinancials.increment(
